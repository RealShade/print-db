...
return [
    ...
    'model_select'           => 'Вибір моделі',
    'edit_part'              => 'Редагування',
    'enum'                   => [
        'status' => [
            'new'         => 'Нове',
    ...
    'action'                 => [
        ...
        'archive' => [
            'title'            => 'Архів завдань',
            'confirm'          => 'Перемістити завдання в архів?',
            'confirm_archived' => 'Повернути завдання з архіву?',
        ],
    ],
    'part' => [
        'add_printed_count' => 'Додати надруковану кількість',
    ]
];
